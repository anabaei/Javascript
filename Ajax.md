...
* [page](http://chat-battle.herokuapp.com/)
#### XML HTTP request 
...
* Browsers prevent apps to make Ajax request to other domains for security reasons but servers allows these type of requests! (therefore we can hit the server from terminal!)
* For Rails app we beed to install `rack-cors` gem,
##### Tools
* online [test](http://www.gameofhacks.com)
* exercise [link](https://www.hackthis.co.uk/levels/basic+/4)
