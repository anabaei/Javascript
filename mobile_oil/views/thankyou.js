...
import {styles} from '../assets/css/thankyou';
...
<View>
    ...
    <View style={styles.container}>
        ...
        <Text style={{fontSize: 44, textAlign: 'center', fontFamily: pop}}> Thank you Title </Text>
        <Text style={{ textAlign: 'center', marginRight: 44, marginLeft: 44, marginTop: 13}} >
